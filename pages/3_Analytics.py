...
with left:
    ...
    fig.update_layout(yaxis=dict(title="On-time %", range=[0, 100]), margin=dict(t=10, b=10))
...
with right:
    ...
    fig2.update_layout(xaxis=dict(title="Avg days"), yaxis=dict(title=""), margin=dict(t=10, b=10))
